...
## 4. 프로그래밍 언어 활용
대부분의 내용이 언어별 문법과 데이터 구조의 표준이다.
C, JAVA, PYTHON으로 직접 코드를 짜본 사람이라면 전혀 신경쓰지 않아도 무방하다.
필요하다면 [code/0-Education]에서 예제를 잠시 훑어보고 가도 좋다.


컴퓨터 구조와 운영체제에 대한 기초적인 내용이 다소 포함되어 있다.
그러나 페이징/세그멘테이션과 프로세스 스케줄링에 대해 알고 있다면 파일 구조에 대한 내용을 넘어가도 좋다.
...
[code/0-Education]: https://github.com/baejaeho18/code/tree/main/0-Education